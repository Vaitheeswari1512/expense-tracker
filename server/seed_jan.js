...
const run = async () => {
    try {
        ...
        // Let's first delete any existing 2026-01 transactions for this user so it can be re-run safely if needed
        ...
        console.log('Successfully inserted January 2026 records.');
